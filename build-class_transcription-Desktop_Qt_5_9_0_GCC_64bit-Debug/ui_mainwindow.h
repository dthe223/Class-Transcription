...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(9, 9, 691, 271));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 687, 153));
...
"}"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        startPauseBtn->setText(QApplication::translate("MainWindow", "Start", Q_NULLPTR));
